  ...
  constructor(size: number, mines: number) {
    ...
    for (let y = 0; y < size; y++) {
      for (let x = 0; x < size; x++) {
        ...
        this.cells[y][x].proximaMinas = adjacentMinas;
    ...
    this.celdaRestante = size * size - this.mineCount;
  }
